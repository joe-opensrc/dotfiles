...
function zcd(){
    cd "$( find ${1:-.} -maxdepth 1 -type d -exec realpath '{}' \; | sort | fzfr +m --preview='{ echo -e "{}\n"; ls --color=always --group-directories-first -F {}; }' --preview-window='right:50%:wrap' --bind 'alt-j:preview-page-down,alt-k:preview-page-up' )"
}
